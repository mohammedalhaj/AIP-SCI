...
import com.aspire.sci.AspireAutomationSciApplication;
/**
...
@SpringBootTest(webEnvironment = WebEnvironment.DEFINED_PORT, classes = { AspireAutomationSciApplication.class,
		AspireAutomationAutoconfigurationApplication.class }) 

public class AspireAutomationSciApplicationTest extends AspireDefaultTestRunner {
